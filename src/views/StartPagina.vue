...
<template>
  <div class="home">
    <NavigatieBalk />
      ...
      <div class="container-fluid font-secondary">
          <div class="row" id="homeWrapper">
              ...
              <section class="col-12">
                <div class="row quote-container justify-content-center" :style="`background-image: url('${homePage1}')`">
                      <div class="col-10">
                          <div class="mt-5"></div>
                          <div class="row">
                              <div class="col-2 col-md-4"></div>
    ...
    <LightBox>
        ...
        <div class="intro-text-subtitle">Deze week zullen er onder het thema 'The sky is the limit' elke avond activiteiten zijn waarbij je de vereniging beter kan leren kennen!</div>
