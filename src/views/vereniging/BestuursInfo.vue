...
<template>
    ...
    <StandardLayoutWithHeader pageHeader="Bestuur der C.S.V. Ichthus Utrecht"
        ...
        <div class="row justify-content-center">
            ...
            <BestuursPerson imageNumber="4" name="Rhodé Lodewijks" function="Assessor Intern" email="assessor.intern@ichthusutrecht.nl">
            ...
            <BestuursPerson imageNumber="5" name="Inge van de Bruinhorst" function="Assessor Extern" email="assessor.extern@ichthusutrecht.nl">
            ...
            <BestuursPerson imageNumber="6" name="Maaike de Vries" function="Herus" email="herus@ichthusutrecht.nl">
